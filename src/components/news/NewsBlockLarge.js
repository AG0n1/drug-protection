...
class NewsBlockLarge extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div style={style} className="news-block news-block-large">
                <div className="dark-text">
                    ...
                    <div className="likes-dislikes">
                        ...
                        <h1 className="likes">{this.state.likeCount}</h1>
                        <div onClick={this.PlusDislike}>
                            <Image image={dislike} />
                        </div>
                        <h1 className="likes">{this.state.dislikeCount}</h1>
                    </div>
                </div>
            </div>
        );
